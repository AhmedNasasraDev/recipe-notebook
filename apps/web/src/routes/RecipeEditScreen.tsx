          ...
          <label className={styles.checkRow}>
            ...
            <span>
              ...
              <span className={styles.hint}>
                נמדד במשקל בתוך מתכונים אחרים, ולא מומר לנפח
              </span>
            </span>
          </label>
        </section>
                  ...
                  */}
                  <details className={styles.more} open={row.subId !== ''}>
                    ...
                    <div className={styles.field}>
                      ...
                      <p className={styles.hint}>
                        {row.subId
                          ? 'הכמות נמדדת במשקל והעלות מתגלגלת מהמתכון המקושר. שורה כזאת אינה מומרת לנפח.'
          ...
          <section className={styles.card}>
            ...
            */}
            ...
            <div className={styles.field}>
              ...
              />
              <p className={styles.hint}>
                ההערות האלה נוסעות עם המתכון בשיתוף ובדף ההזמנה.
              </p>
            </div>
          </section>
          </div>
